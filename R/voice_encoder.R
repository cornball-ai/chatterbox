...
{
    list(num_mels = 40, sample_rate = 16000, speaker_embed_size = 256,
         ve_hidden_size = 256, n_fft = 400, hop_size = 160, win_size = 400,
         fmax = 8000, fmin = 0, ve_partial_frames = 160,
         ve_final_relu = TRUE, normalized_mels = FALSE)
}
...
voice_encoder <- torch::nn_module(
    ...
    # 3-layer LSTM
    self$lstm <- torch::nn_lstm(input_size = config$num_mels,
